...
class collate_batch(object):
    ...
    def __init__(self, padding_value=3.0):
    ...
    def __call__(self, batch):
        ...
        output = (pad_sequence(premise_list, padding_value=self.padding_value),
                  pad_sequence(hypothesis_list, padding_value=self.padding_value),
                  torch.stack(labels_list))

        return output


def snli_dataloaders(batch_size, snli_path="./data/snli", num_workers=0, padding_value=3.0, shuffle_train=True):
    """[summary]
    ...
    collate_fn = collate_batch(padding_value=padding_value)
